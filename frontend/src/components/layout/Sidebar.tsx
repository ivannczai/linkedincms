...
import {
	...
	Link2,
	X,
} from 'lucide-react'; // Added Settings, Link2 icons
...
const Sidebar: React.FC<SidebarProps> = ({ isOpen, setIsOpen }) => {
	...
	// Common link classes
	const linkClasses =
		'flex items-center px-3 py-2.5 rounded-md text-sm font-medium text-gray-300 hover:bg-secondary-700 hover:text-white transition-colors duration-150';
	...
	const sidebarBaseClasses =
		'w-64 h-screen bg-secondary-900 text-secondary-100 flex flex-col fixed shadow-lg z-30 transition-transform duration-300 ease-in-out';
	...
	return (
		<>
			...
			{/* Sidebar */}
			<div
				className={`${sidebarBaseClasses} ${isOpen ? sidebarMobileOpen : sidebarMobileClosed} ${sidebarDesktop}`}
			>
				{/* Header */}
